...
extern const u8 BattleScript_ExtremeHeatContinues[];
...
extern const u8 BattleScript_ArmorTailProtected[];
...
extern const u8 BattleScript_MoveUsedIsGravityPrevented[];
...
extern const u8 BattleScript_TraceDownloadActivates[];
...
extern const u8 BattleScript_ItemActivatesRain[];
extern const u8 BattleScript_ItemActivatesSun[];
extern const u8 BattleScript_ItemActivatesSandstorm[];
extern const u8 BattleScript_ItemActivatesHailstorm[];
extern const u8 BattleScript_TookAttack[];
extern const u8 BattleScript_SturdyPreventsOHKO[];
extern const u8 BattleScript_DampStopsExplosion[];
extern const u8 BattleScript_MoveHPDrain_PPLoss[];
extern const u8 BattleScript_MoveHPDrain[];
extern const u8 BattleScript_SurfMoveHPDrain_PPLoss[];
extern const u8 BattleScript_SurfMoveHPDrain[];
extern const u8 BattleScript_DischargeMoveHPDrain_PPLoss[];
extern const u8 BattleScript_DischargeMoveHPDrain[];
extern const u8 BattleScript_MonMadeMoveUseless_PPLoss[];
extern const u8 BattleScript_MonMadeMoveUseless[];
extern const u8 BattleScript_SurfMonMadeMoveUseless_PPLoss[];
extern const u8 BattleScript_SurfMonMadeMoveUseless[];
extern const u8 BattleScript_DischargeMonMadeMoveUseless_PPLoss[];
extern const u8 BattleScript_DischargeMonMadeMoveUseless[];
extern const u8 BattleScript_FlashFireBoost_PPLoss[];
extern const u8 BattleScript_FlashFireBoost[];
extern const u8 BattleScript_DischargeFlashFireBoost_PPLoss[];
extern const u8 BattleScript_DischargeFlashFireBoost[];
extern const u8 BattleScript_LightningRodActivates_PPLoss[];
extern const u8 BattleScript_LightningRodActivates[];
extern const u8 BattleScript_DischargeLightningRodActivates_PPLoss[];
extern const u8 BattleScript_DischargeLightningRodActivates[];
extern const u8 BattleScript_SurfTargetAbilityRaisesSpAtk_PPLoss[];
extern const u8 BattleScript_SurfTargetAbilityRaisesSpAtk[];
extern const u8 BattleScript_TargetAbilityRaisesSpeed_PPLoss[];
extern const u8 BattleScript_TargetAbilityRaisesSpeed[];
extern const u8 BattleScript_DischargeTargetAbilityRaisesSpeed_PPLoss[];
extern const u8 BattleScript_DischargeTargetAbilityRaisesSpeed[];
extern const u8 BattleScript_TargetAbilityRaisesAttack_PPLoss[];
extern const u8 BattleScript_TargetAbilityRaisesAttack[];
...
extern const u8 BattleScript_StatDropRattledActivates[];
extern const u8 BattleScript_StatDropDefiantActivates[];
extern const u8 BattleScript_StatDropCompetitiveActivates[];
...
extern const u8 BattleScript_EnigmaBerryHealRet[];
extern const u8 BattleScript_BerryPPHealEnd2[];
extern const u8 BattleScript_ItemHealHP_End2[];
extern const u8 BattleScript_ItemHealHP_Ret[];
extern const u8 BattleScript_FlameOrbBurn[];
extern const u8 BattleScript_ToxicOrbBadlyPoisons[];
extern const u8 BattleScript_LifeOrbRecoil[];
extern const u8 BattleScript_SelectingNotAllowedMoveChoiceItem[];
extern const u8 BattleScript_HungOnMsg[];
