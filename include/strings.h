...
extern const u8 gText_Stats_BaseStats[];
...
extern const u8 gText_Stats_EvYield[];
...
extern const u8 gText_Stats_EggMove_Egg[];
extern const u8 gText_Stats_EggMove_Move[];
extern const u8 gText_Stats_MoveTutor_Move[];
extern const u8 gText_Stats_MoveTutor_Tutor[];
...
extern const u8 gText_RockIceAndSteel[];
extern const u8 gText_TheColossus[];
extern const u8 gText_GalarsTitans[];
...
extern const u8 gText_AdamantMint6BP[];
extern const u8 gText_BoldMint6BP[];
extern const u8 gText_BraveMint6BP[];
extern const u8 gText_CalmMint6BP[];
extern const u8 gText_CarefulMint6BP[];
extern const u8 gText_GentleMint6BP[];
extern const u8 gText_HastyMint6BP[];
extern const u8 gText_ImpishMint6BP[];
extern const u8 gText_JollyMint6BP[];
extern const u8 gText_LaxMint6BP[];
extern const u8 gText_LonelyMint6BP[];
extern const u8 gText_MildMint6BP[];
extern const u8 gText_ModestMint6BP[];
extern const u8 gText_NaiveMint6BP[];
extern const u8 gText_NaughtyMint6BP[];
extern const u8 gText_QuietMint6BP[];
extern const u8 gText_RashMint6BP[];
extern const u8 gText_RelaxedMint6BP[];
extern const u8 gText_SassyMint6BP[];
extern const u8 gText_SeriousMint6BP[];
extern const u8 gText_TimidMint6BP[];
extern const u8 gText_AbilityCapsule12BP[];
extern const u8 gText_BottleCap16BP[];
extern const u8 gText_AbilityPatch24BP[];
extern const u8 gText_GoldBottleCap64BP[];

extern const u8 gText_FocusSash2BP[];
extern const u8 gText_Eviolite8BP[];
extern const u8 gText_FlameOrb16BP[];
extern const u8 gText_ToxicOrb16BP[];
extern const u8 gText_LifeOrb24BP[];
...
extern const u8 gText_ExpertBelt48BP[];
...
extern const u8 gText_InfoStats[];
extern const u8 gText_InfoIvs[];
extern const u8 gText_InfoEvs[];
...
extern const u8 gText_NoRoomForThatMuchMoney[];
...
extern const u8 MatchCall_Text_Mom_Outbreak[];
...
extern const u8 gText_PokenavAccessPC[];
...
extern const u8 gText_PokenavCannotAccessPC[];
