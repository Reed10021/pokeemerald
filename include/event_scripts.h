...
extern const u8 EventScript_TryDoRematchBattleContinueScript[];
...
extern const u8 EventScript_UseFlashToolText[];
extern const u8 EventScript_SmashRock[];
extern const u8 EventScript_UseRockSmash[];
extern const u8 EventScript_UseRockSmashTool[];
extern const u8 EventScript_UseRockSmashToolText[];
...
extern const u8 EventScript_UseDiveToolText[];
