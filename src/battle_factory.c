...
{
    // Level 50
    {FRONTIER_MON_GRIMER,       FRONTIER_MON_MELTAN_1},      // 110 - 211
    {FRONTIER_MON_DELCATTY_1,   FRONTIER_MON_CLOYSTER_1},    // 169 - 278
    {FRONTIER_MON_DELCATTY_2,   FRONTIER_MON_PROBOPASS_1},   // 279 - 392
    {FRONTIER_MON_LICKILICKY_1, FRONTIER_MON_LEAFEON_1},     // 390 - 508
    {FRONTIER_MON_DUGTRIO_2,    FRONTIER_MON_HONCHKROW_3},   // 509 - 615
    {FRONTIER_MON_DUGTRIO_3,    FRONTIER_MON_DUSKNOIR_4},    // 616 - 734
    {FRONTIER_MON_DUGTRIO_4,    FRONTIER_MON_GOODRA_HISUI_2},// 735 - 860
    {FRONTIER_MON_LICKILICKY_1, FRONTIER_MONS_HIGH_TIER},    // 390 - 989
    ...
    {FRONTIER_MON_DUGTRIO_3,    FRONTIER_MON_DUSKNOIR_4},     // 616 - 734
    {FRONTIER_MON_DUGTRIO_4,    FRONTIER_MON_GOODRA_HISUI_2}, // 735 - 860
    {FRONTIER_MON_LICKILICKY_1, NUM_FRONTIER_MONS - 1},       // 390 - 1091
    {FRONTIER_MON_LICKILICKY_1, NUM_FRONTIER_MONS - 1},       // 390 - 1091
    {FRONTIER_MON_LICKILICKY_1, NUM_FRONTIER_MONS - 1},       // 390 - 1091
    {FRONTIER_MON_LICKILICKY_1, NUM_FRONTIER_MONS - 1},       // 390 - 1091
};
