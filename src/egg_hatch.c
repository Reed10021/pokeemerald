...
static void CreateHatchedMon(struct Pokemon *egg, struct Pokemon *temp)
{
    ...
    u8 i, friendship, language, gameMet, markings, obedience, hasHiddenAbility;
    ...
    hasHiddenAbility = GetMonData(egg, MON_DATA_HAS_HIDDEN_ABILITY);
    ...
    SetMonData(temp, MON_DATA_HAS_HIDDEN_ABILITY, &hasHiddenAbility);
