...
{ 
    [OPTIONS_TEXT_SPEED_SLOW] = 1, // 8
    [OPTIONS_TEXT_SPEED_MID]  = 1, // 4
    [OPTIONS_TEXT_SPEED_FAST] = 1  // 1
};
    ...
    *(string++) = color + 1;
    switch (textId)
    {
        ...
        case SAVE_MENU_PLAY_TIME:
            string = ConvertIntToDecimalStringN(string, gSaveBlock2Ptr->playTimeHours, STR_CONV_MODE_LEFT_ALIGN, 5);
            *(string++) = CHAR_COLON;
