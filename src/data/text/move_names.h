const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH] =
{
    [MOVE_NONE] = _("-"),
    [MOVE_POUND] = _("POUND"),
    ...
    [MOVE_FAINT_ATTACK] = _("FEINT ATTACK"), // Faint -> Feint
    ...
    [MOVE_MIRACLE_EYE ... MOVE_WAKE_UP_SLAP] = _("UNUSED"),
    [MOVE_HAMMER_ARM] = _("HAMMER ARM"),
    [MOVE_GYRO_BALL ... MOVE_PLUCK] = _("UNUSED"),
    [MOVE_TAILWIND] = _("TAILWIND"),
    [MOVE_ACUPRESSURE ... MOVE_METAL_BURST] = _("UNUSED"),
    [MOVE_U_TURN] = _("U-TURN"),
    [MOVE_CLOSE_COMBAT] = _("CLOSE COMBAT"),
    [MOVE_PAYBACK ... MOVE_AQUA_RING] = _("UNUSED"),
    ...
    [MOVE_SWITCHEROO ... MOVE_GIGA_IMPACT] = _("UNUSED"),
    ...
    [MOVE_SHADOW_SNEAK ... MOVE_MUD_BOMB] = _("UNUSED"),
    ...
    [MOVE_ROCK_CLIMB ... MOVE_DEFOG] = _("UNUSED"),
    [MOVE_TRICK_ROOM] = _("TRICK ROOM"),
    [MOVE_DRACO_METEOR] = _("UNUSED"),
    ...
    [MOVE_CAPTIVATE ... MOVE_STEALTH_ROCK] = _("UNUSED"),
    [MOVE_GRASS_KNOT] = _("GRASS KNOT"),
    [MOVE_CHATTER ... MOVE_BUG_BITE] = _("UNUSED"),
    [MOVE_CHARGE_BEAM] = _("CHARGE BEAM"),
    [MOVE_WOOD_HAMMER ... MOVE_HEAD_SMASH] = _("UNUSED"),
    [MOVE_DOUBLE_HIT] = _("DOUBLE HIT"),
    [MOVE_ROAR_OF_TIME ... MOVE_LUNAR_DANCE] = _("UNUSED"),
    [MOVE_CRUSH_GRIP] = _("CRUSH GRIP"),
    [MOVE_MAGMA_STORM ... MOVE_SEED_FLARE] = _("UNUSED"),
    [MOVE_OMINOUS_WIND] = _("OMINOUS WIND"),
    [MOVE_SHADOW_FORCE ... MOVE_HONE_CLAWS] = _("UNUSED"),
    [MOVE_WIDE_GUARD] = _("WIDE GUARD"),
    [MOVE_PSYSHOCK ... MOVE_AUTOTOMIZE] = _("UNUSED"),
    [MOVE_RAGE_POWDER] = _("RAGE POWDER"),
    [MOVE_SMACK_DOWN] = _("UNUSED"),
    [MOVE_HEX] = _("HEX"),
    ...
    [MOVE_ORIGIN_PULSE ... MOVE_PRECIPICE_BLADES] = _("UNUSED"),
