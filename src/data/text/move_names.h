const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH] =
{
    ...
    [MOVE_ROOST ... MOVE_U_TURN] = _("UNUSED"),
    [MOVE_CLOSE_COMBAT] = _("CLOSE COMBAT"),
    [MOVE_PAYBACK ... MOVE_MAGNET_RISE] = _("UNUSED"),
    ...
    [MOVE_NIGHT_SLASH ... MOVE_AQUA_TAIL] = _("UNUSED"),
    ...
    [MOVE_DRAGON_RUSH ... MOVE_POWER_GEM] = _("UNUSED"),
    [MOVE_DRAIN_PUNCH] = _("DRAIN PUNCH"),
    [MOVE_VACUUM_WAVE ... MOVE_ENERGY_BALL] = _("UNUSED"),
    [MOVE_BRAVE_BIRD] = _("BRAVE BIRD"),
    [MOVE_EARTH_POWER ... MOVE_GIGA_IMPACT] = _("UNUSED"),
