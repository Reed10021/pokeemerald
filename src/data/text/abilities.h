...
static const u8 sTitanicDescription[] = _("Anchored, unflinching, slow.");
...
static const u8 sSlushRushDescription[] = _("Ups SPEED in hail.");
...
static const u8 sPyroReactorDescription[] = _("Fire raises SPEED.");
...
static const u8 sArticForceDescription[] = _("Powers up in hail.");
static const u8 sTransistorDescription[] = _("Boosts ELECTRIC moves.");
static const u8 sDragonsMawDescription[] = _("Boosts DRAGON moves.");
static const u8 sMegaSolDescription[] = _("Moves are sun-charged.");
static const u8 sDragonizeDescription[] = _("NORMAL becomes DRAGON.");
static const u8 sSharpnessDescription[] = _("Boosts slicing moves.");
static const u8 sSolidRockDescription[] = _("Weakens “super effective”.");
...
static const u8 sOvercastDescription[] = _("Inverted “Forecast”.");
...
static const u8 sMagicGuardDescription[] = _("Only attacks cause damage.");
static const u8 sAngerPointDescription[] = _("Critical hits max ATTACK.");
static const u8 sDefiantDescription[] = _("Stat drops boost ATTACK.");
static const u8 sOvercoatDescription[] = _("Blocks weather and powder.");
static const u8 sCompetitiveDescription[] = _("Stat drops boost SP. ATK.");
...
static const u8 sSkillLinkDescription[] = _("Multi-hit moves hit max.");
...
static const u8 sBulletproofDescription[] = _("Blocks ball and bomb moves.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_PYRO_REACTOR] = _("PYRO REACTOR"),
    ...
    [ABILITY_ARTIC_FORCE] = _("ARTIC FORCE"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_PYRO_REACTOR] = sPyroReactorDescription,
    ...
    [ABILITY_ARTIC_FORCE] = sArticForceDescription,
    ...
    [ABILITY_OVERCAST] = sOvercastDescription,
