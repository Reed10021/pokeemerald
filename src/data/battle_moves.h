const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_FIRE_PUNCH] =
    {
        ...
        .power = 75,
        .type = TYPE_FIRE,
        .category = DAMAGE_CATEGORY_VARIABLE,
        .accuracy = 100,
        .pp = 15,
    ...
    // 40% chance to raise attacker's ATK by 1 stage
    [MOVE_NEEDLE_ARM] =
    {
        .effect = EFFECT_ATTACK_UP_HIT,
        .power = 65,
    ...
    // Dragon Dance boosts ATK, SPATK, and SPD by 1 stage each.
    [MOVE_DRAGON_DANCE] =
    {
    ...
    [MOVE_MIRACLE_EYE ... MOVE_WAKE_UP_SLAP] =
    {
        // Unused / Placeholder
        .effect = EFFECT_HIT,
        .power = 0,
    ...
    [MOVE_ACUPRESSURE ... MOVE_METAL_BURST] =
    {
        // Unused / Placeholder
        .effect = EFFECT_HIT,
        .power = 0,
    ...
    [MOVE_SWITCHEROO ... MOVE_GIGA_IMPACT] =
    {
        // Unused / Placeholder
        .effect = EFFECT_HIT,
        .power = 0,
    ...
    [MOVE_SHADOW_SNEAK ... MOVE_MUD_BOMB] =
    {
        // Unused / Placeholder
        .effect = EFFECT_HIT,
        .power = 0,
    ...
    [MOVE_CAPTIVATE ... MOVE_STEALTH_ROCK] =
    {
        // Unused / Placeholder
        .effect = EFFECT_HIT,
        .power = 0,
    ...
    [MOVE_WOOD_HAMMER ... MOVE_HEAD_SMASH] =
    {
        // Unused / Placeholder
        .effect = EFFECT_HIT,
        .power = 0,
    ...
    [MOVE_ROAR_OF_TIME ... MOVE_LUNAR_DANCE] =
    {
        // Unused / Placeholder
        .effect = EFFECT_HIT,
        .power = 0,
    ...
    [MOVE_MAGMA_STORM ... MOVE_SEED_FLARE] =
    {
        // Unused / Placeholder
        .effect = EFFECT_HIT,
        .power = 0,
    ...
    [MOVE_SHADOW_FORCE ... MOVE_HONE_CLAWS] =
    {
        // Unused / Placeholder
        .effect = EFFECT_HIT,
        .power = 0,
    ...
    [MOVE_HEX] =
    {
        .effect = EFFECT_CONDITIONAL_DOUBLE_DAMAGE_HIT,
        .power = 65,
        .type = TYPE_GHOST,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .accuracy = 100,
    ...
    [MOVE_SACRED_SWORD] =
    {
        .effect = EFFECT_IGNORE_DEFENSE_EVASION_HIT,
        .power = 90,
        .type = TYPE_FIGHTING,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .accuracy = 100,
    ...
    [MOVE_PSYSTRIKE] =
    {
        .effect = EFFECT_USE_TARGET_DEFENSE_HIT,
        .power = 100,
        .type = TYPE_PSYCHIC,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .accuracy = 100,
    ...
    [MOVE_ORIGIN_PULSE ... MOVE_PRECIPICE_BLADES] =
    {
        // Unused / Placeholder
        .effect = EFFECT_HIT,
        .power = 0,
