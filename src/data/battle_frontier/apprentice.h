...
static const bool8 sValidApprenticeMoves[MOVES_COUNT] =
{
    ...
    [MOVE_ROOST] = TRUE,
    [MOVE_GRAVITY] = TRUE,
    [MOVE_MIRACLE_EYE ... MOVE_WAKE_UP_SLAP] = FALSE,
    [MOVE_HAMMER_ARM] = TRUE,
    [MOVE_GYRO_BALL ... MOVE_METAL_BURST] = FALSE,
    [MOVE_U_TURN] = TRUE,
    [MOVE_CLOSE_COMBAT] = TRUE,
    [MOVE_PAYBACK ... MOVE_AQUA_RING] = FALSE,
    [MOVE_MAGNET_RISE] = TRUE,
    [MOVE_FLARE_BLITZ] = TRUE,
    [MOVE_FORCE_PALM] = TRUE,
    [MOVE_AURA_SPHERE] = TRUE,
    ...
    [MOVE_CAPTIVATE ... MOVE_STEALTH_ROCK] = FALSE,
    [MOVE_GRASS_KNOT] = TRUE,
    [MOVE_CHATTER ... MOVE_BUG_BITE] = FALSE,
    [MOVE_CHARGE_BEAM] = TRUE,
    [MOVE_WOOD_HAMMER ... MOVE_HEAD_SMASH] = FALSE,
    [MOVE_DOUBLE_HIT] = TRUE,
    [MOVE_ROAR_OF_TIME ... MOVE_LUNAR_DANCE] = FALSE,
    [MOVE_CRUSH_GRIP] = TRUE,
    [MOVE_MAGMA_STORM ... MOVE_SEED_FLARE] = FALSE,
    [MOVE_OMINOUS_WIND] = TRUE,
    [MOVE_SHADOW_FORCE ... MOVE_HONE_CLAWS] = FALSE,
    [MOVE_WIDE_GUARD] = TRUE,
    [MOVE_PSYSHOCK ... MOVE_AUTOTOMIZE] = FALSE,
    [MOVE_RAGE_POWDER] = TRUE,
    [MOVE_SMACK_DOWN] = FALSE,
    [MOVE_HEX] = TRUE,
