...
static const bool8 sValidApprenticeMoves[MOVES_COUNT] =
{
    ...
    [MOVE_ROOST ... MOVE_MAGNET_RISE] = FALSE,
    [MOVE_FLARE_BLITZ] = TRUE,
    [MOVE_FORCE_PALM ... MOVE_POISON_JAB] = FALSE,
    [MOVE_DARK_PULSE] = TRUE,
    [MOVE_NIGHT_SLASH ... MOVE_SEED_BOMB] = FALSE,
    [MOVE_AIR_SLASH] = TRUE,
    [MOVE_X_SCISSOR ... MOVE_BUG_BUZZ] = FALSE,
    [MOVE_DRAGON_PULSE] = TRUE,
    [MOVE_DRAGON_RUSH ... MOVE_POWER_GEM] = FALSE,
    [MOVE_DRAIN_PUNCH] = TRUE,
    [MOVE_VACUUM_WAVE ... MOVE_NASTY_PLOT] = FALSE,
    [MOVE_BULLET_PUNCH] = TRUE,
    [MOVE_AVALANCHE] = TRUE,
    [MOVE_ICE_SHARD] = TRUE,
    [MOVE_SHADOW_CLAW] = TRUE,
    [MOVE_THUNDER_FANG ... MOVE_LUNAR_DANCE] = FALSE,
