...
static const bool8 sValidApprenticeMoves[MOVES_COUNT] =
{
    ...
    [MOVE_ROOST ... MOVE_U_TURN] = FALSE,
    [MOVE_CLOSE_COMBAT] = TRUE,
    [MOVE_PAYBACK ... MOVE_MAGNET_RISE] = FALSE,
    ...
    [MOVE_NIGHT_SLASH ... MOVE_AQUA_TAIL] = FALSE,
    [MOVE_SEED_BOMB] = TRUE,
    [MOVE_AIR_SLASH] = TRUE,
    [MOVE_X_SCISSOR] = TRUE,
    [MOVE_BUG_BUZZ] = TRUE,
    [MOVE_DRAGON_PULSE] = TRUE,
    [MOVE_DRAGON_RUSH ... MOVE_POWER_GEM] = FALSE,
    [MOVE_DRAIN_PUNCH] = TRUE,
    [MOVE_VACUUM_WAVE ... MOVE_ENERGY_BALL] = FALSE,
    [MOVE_BRAVE_BIRD] = TRUE,
    [MOVE_EARTH_POWER ... MOVE_GIGA_IMPACT] = FALSE,
    [MOVE_NASTY_PLOT] = TRUE,
    [MOVE_BULLET_PUNCH] = TRUE,
    [MOVE_AVALANCHE] = TRUE,
    [MOVE_ICE_SHARD] = TRUE,
    [MOVE_SHADOW_CLAW] = TRUE,
    [MOVE_THUNDER_FANG ... MOVE_MUD_BOMB] = FALSE,
    [MOVE_PSYCHO_CUT] = TRUE,
    [MOVE_ZEN_HEADBUTT] = TRUE,
    [MOVE_MIRROR_SHOT] = FALSE, // Unused / Placeholder
    [MOVE_FLASH_CANNON] = TRUE,
    [MOVE_ROCK_CLIMB ... MOVE_DEFOG] = FALSE,
    [MOVE_TRICK_ROOM] = TRUE,
    [MOVE_DRACO_METEOR ... MOVE_LUNAR_DANCE] = FALSE,
    [MOVE_CRUSH_GRIP] = TRUE,
    [MOVE_MAGMA_STORM ... MOVE_SHADOW_FORCE] = FALSE,
};
