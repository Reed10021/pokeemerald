const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MAGNETON]   = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_MAGNEZONE},
                            {EVO_IF_IN_MAP, MAP_NEW_MAUVILLE_INSIDE, SPECIES_MAGNEZONE}},
    ...
    [SPECIES_FARFETCHD]  = {{EVO_ITEM, ITEM_DAWN_STONE, SPECIES_SIRFETCHD}},
    [SPECIES_LICKITUNG]  = {{EVO_LEVEL, 34, SPECIES_LICKILICKY}},
    ...
    [SPECIES_SCYTHER]    = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR},
                            {EVO_TRADE_ITEM, ITEM_KINGS_ROCK, SPECIES_KLEAVOR}},
    [SPECIES_MAGIKARP]   = {{EVO_LEVEL, 20, SPECIES_GYARADOS}},
    [SPECIES_TANGELA]    = {{EVO_LEVEL, 35, SPECIES_TANGROWTH}},
    [SPECIES_EEVEE]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_FRIENDSHIP_DAY, 0, SPECIES_ESPEON},
                            {EVO_FRIENDSHIP_NIGHT, 0, SPECIES_UMBREON},
                            {EVO_IF_IN_MAP, MAP_PETALBURG_WOODS, SPECIES_LEAFEON},
                            {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_LEAFEON},
                            {EVO_IF_IN_MAP, MAP_SHOAL_CAVE_LOW_TIDE_ICE_ROOM, SPECIES_GLACEON},
    ...
    [SPECIES_YANMA]      = {{EVO_LEVEL, 34, SPECIES_YANMEGA}},
    ...
    [SPECIES_QWILFISH]   = {{EVO_LEVEL, 28, SPECIES_OVERQWIL}},
    [SPECIES_SNEASEL]    = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_WEAVILE}},
    [SPECIES_GLIGAR]     = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_GLISCOR}},
    ...
    [SPECIES_PILOSWINE]  = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_MAMOSWINE}},
    ...
    [SPECIES_STANTLER]   = {{EVO_ITEM, ITEM_DAWN_STONE, SPECIES_WYRDEER}},
    ...
    [SPECIES_NOSEPASS]   = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_PROBOPASS},
                            {EVO_IF_IN_MAP, MAP_NEW_MAUVILLE_INSIDE, SPECIES_PROBOPASS}},
    ...
    [SPECIES_LITWICK]    = {{EVO_LEVEL, 39, SPECIES_LAMPENT}},
    ...
    [SPECIES_GOOMY]      = {{EVO_LEVEL, 35, SPECIES_SLIGGOO},
                            {EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SLIGGOO_HISUI}},
