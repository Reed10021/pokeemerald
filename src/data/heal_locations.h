static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ROUTE_123_BERRY_MASTER - 1] = {MAP_GROUP(ROUTE123), MAP_NUM(ROUTE123), 22, 7},
    [HEAL_LOCATION_ROUTE_111_REST_STOP - 1] = {MAP_GROUP(ROUTE111), MAP_NUM(ROUTE111), 26, 19},
};
