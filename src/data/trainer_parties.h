...
static const struct TrainerMonItemCustomMoves sParty_WallyVR1[] = {
    ...
    .abilityNum = 1,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CONFUSE_RAY, MOVE_THUNDERBOLT, MOVE_HIDDEN_POWER, MOVE_METAL_SOUND}
    },
    {
    .iv = 250,
    .lvl = 45,
    ...
    .abilityNum = 1,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_ICE_PUNCH, MOVE_PSYCHIC, MOVE_HYPNOSIS}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Chris_Crystal[] = {
    ...
    .abilityNum = 1,
    .heldItem = ITEM_MYSTIC_WATER,
    .moves = {MOVE_NASTY_PLOT, MOVE_HYDRO_PUMP, MOVE_THUNDER, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 100,
