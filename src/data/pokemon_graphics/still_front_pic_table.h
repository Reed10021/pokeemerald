...
// Gen III
    ...
    SPECIES_SPRITE(SLIGGOO_HISUI, gMonStillFrontPic_SliggooHisui),
    SPECIES_SPRITE(GOODRA_HISUI,  gMonStillFrontPic_GoodraHisui),
    ...
    SPECIES_SPRITE(OVERQWIL,      gMonStillFrontPic_Overqwil),
