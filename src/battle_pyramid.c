...
static const u16 sPickupItemsLvl50[TOTAL_ROUNDS][PICKUP_ITEMS_PER_ROUND] =
{
    ...
    {ITEM_HYPER_POTION, ITEM_X_DEFEND, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LEPPA_BERRY, ITEM_REVIVE, ITEM_PUNCHING_GLOVE, ITEM_CHOICE_SCARF, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
};
