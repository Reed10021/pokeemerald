...
static const u16 sPickupItemsLvl50[TOTAL_ROUNDS][PICKUP_ITEMS_PER_ROUND] =
{
    ...
    {ITEM_MAX_POTION,   ITEM_X_DEFEND, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LEPPA_BERRY, ITEM_REVIVE, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_HYPER_POTION, ITEM_X_SPEED, ITEM_CHESTO_BERRY, ITEM_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_FOCUS_SASH, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    ...
    {ITEM_HYPER_POTION, ITEM_X_SP_DEF, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_DIRE_HIT, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LEPPA_BERRY, ITEM_REVIVE, ITEM_PUNCHING_GLOVE, ITEM_CHOICE_SCARF, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_HYPER_POTION, ITEM_X_ATTACK, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_FOCUS_SASH, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_MAX_POTION,   ITEM_X_DEFEND, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LEPPA_BERRY, ITEM_REVIVE, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    ...
    {ITEM_HYPER_POTION, ITEM_X_SP_DEF, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LEPPA_BERRY, ITEM_REVIVE, ITEM_LEFTOVERS, ITEM_CHOICE_SPECS, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    ...
    {ITEM_MAX_POTION,   ITEM_X_DEFEND, ITEM_LUM_BERRY, ITEM_ETHER, ITEM_LEPPA_BERRY, ITEM_REVIVE, ITEM_PUNCHING_GLOVE, ITEM_CHOICE_SCARF, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
};
...
void GenerateBattlePyramidWildMon(void)
{
    ...
    // BUG: (fixed) Reading outside the array as lvl was used for mon level instead of frontier lvl mode.
...
static bool8 SetPyramidObjectPositionsInAndNearSquare(u8 objType, u8 squareId)
{
    ...
    free(floorLayoutOffsets); // BUG: (fixed) floorLayoutOffsets memory not freed
