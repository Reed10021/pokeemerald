...
static const u8 LandmarkName_OutcastIsland[] = _("OUTCAST ISLAND");
...
static const struct Landmark Landmark_OutcastIsland = { LandmarkName_OutcastIsland, FLAG_JIRACHI_DOOR };
