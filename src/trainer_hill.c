...
static const u16 sPrizeListSunnyDay[]    = {ITEM_MAX_REVIVE,       ITEM_ETHER, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL, ITEM_PREMIER_BALL}; //Normal Prize list
...
static const u16 sPrizeListElixir2[]     = {ITEM_ELIXIR,           ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL}; //Variety Prize List
static const u16 sPrizeListBrickBreak[]  = {ITEM_MASTER_BALL,      ITEM_RARE_CANDY, ITEM_FULL_RESTORE, ITEM_MAX_REVIVE, ITEM_MAX_ETHER, ITEM_ULTRA_BALL}; //Expert Prize List
...
static const u16 sPrizeListGigaDrain[]   = {ITEM_RARE_CANDY,       ITEM_MAX_ETHER, ITEM_MAX_POTION, ITEM_MAX_REVIVE, ITEM_ULTRA_BALL, ITEM_PREMIER_BALL}; //Unique Prize List
