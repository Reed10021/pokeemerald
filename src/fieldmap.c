...
#define UBFIX
#ifndef UBFIX
    // BUG: (fixed) This loop extends past the bounds of the mapView array. Its size is only 0x100.
    for (i = 0; i < 0x200; i++)
...
void nullsub_3(u16 a0, u16 a1) // ApplyGlobalTintToPaletteEntries
{

}

void nullsub_90(void) // ApplyGlobalTintToPaletteSlot
{
