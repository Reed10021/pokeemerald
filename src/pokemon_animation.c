...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_DEOXYS_ATTACK] = BACK_ANIM_GROW_2,
    [SPECIES_DEOXYS_DEFENSE] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_DEOXYS_SPEED] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_REGIGIGAS] = BACK_ANIM_V_SHAKE_WITH_PAUSE,
    ...
    [SPECIES_LEAFEON] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_GLACEON] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_WEAVILE] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_MAGNEZONE] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_ROSERADE] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_LICKILICKY] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_RHYPERIOR] = BACK_ANIM_VERTICAL_SHAKE,
    [SPECIES_TANGROWTH] = BACK_ANIM_GROW_1,
    [SPECIES_AMBIPOM] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_MISMAGIUS] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_HONCHKROW] = BACK_ANIM_HORIZONTAL_STRETCH,
    [SPECIES_ELECTIVIRE] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_MAGMORTAR] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_TOGEKISS] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_YANMEGA] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_GLISCOR] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_MAMOSWINE] = BACK_ANIM_V_SHAKE_WITH_PAUSE,
    [SPECIES_PORYGON_Z] = BACK_ANIM_H_SLIDE_QUICK,
    [SPECIES_GALLADE] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_PROBOPASS] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_DUSKNOIR] = BACK_ANIM_SHRINK_GROW_2,
    [SPECIES_FROSLASS] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_RIOLU] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_SMALL,
    [SPECIES_LUCARIO] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    ...
    [SPECIES_GALVANTULA] = BACK_ANIM_FLASH_YELLOW_WITH_SHAKE,
    [SPECIES_LITWICK] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_LAMPENT] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_CHANDELURE] = BACK_ANIM_CONCAVE_DOWN_ARC_SWAY_LARGE,
    [SPECIES_LARVESTA] = BACK_ANIM_H_SLIDE,
    [SPECIES_VOLCARONA] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_GOOMY] = BACK_ANIM_H_SLIDE_WITH_V_COMPRESS_1,
    [SPECIES_SLIGGOO] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_GOODRA] = BACK_ANIM_SHRINK_GROW_1,
    [SPECIES_SLIGGOO_HISUI] = BACK_ANIM_NONE,
    [SPECIES_GOODRA_HISUI] = BACK_ANIM_NONE,
    [SPECIES_SNOM] = BACK_ANIM_NONE,
    [SPECIES_FROSMOTH] = BACK_ANIM_NONE,
    [SPECIES_SIRFETCHD] = BACK_ANIM_NONE,
    [SPECIES_ANNIHILAPE] = BACK_ANIM_NONE,
    [SPECIES_KLEAVOR] = BACK_ANIM_NONE,
    [SPECIES_FARIGIRAF] = BACK_ANIM_NONE,
    [SPECIES_DUDUNSPARCE] = BACK_ANIM_NONE,
...
static void sub_817F77C(struct Sprite *sprite)
{
    ...
    {
        // BUG: (fixed) Reset these back to normal after they were changed so Poké Ball catch/release
